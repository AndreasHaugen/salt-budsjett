...
export const ProjectHeader: React.FC<Props> = ({ info, onChange }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 mb-8 print:shadow-none print:border-slate-300 print:mb-4">
      <div className="flex items-center gap-2 mb-6 border-b border-slate-100 pb-4 print:border-slate-200">
        <LayoutDashboard className="w-5 h-5 text-indigo-500 print:text-indigo-700" />
